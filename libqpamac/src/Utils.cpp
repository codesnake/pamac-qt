...
#include "Utils.h"
#include <cstring>
std::vector<char *> LibQPamac::Utils::qStringListToCStringVector(const QStringList &inList)
{
...
QStringList LibQPamac::Utils::cStringArrayToQStringList(char **arr, int size)
{
    QStringList result;
...
GList *LibQPamac::Utils::qVariantListToGList(const QVariantList &lst)
{
